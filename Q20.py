...
input_str1 = input()#Enter the array elements separated by spaces:
sample1 = list(map(int, input_str1.split()))
input_str2 = input()#Enter the array elements separated by spaces:
sample2 = list(map(int, input_str2.split()))
p_value = perform_hypothesis_test(sample1, sample2)
print("P-value:", p_value)
